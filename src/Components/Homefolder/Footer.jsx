...
//             <div className="grid lg:grid-cols-5 md:grid-cols-5 sm:grid-cols-2 grid-cols-2 gap-6">
//               <div>
//                 <img
//                   src={sslogo}
...
//           <div className="lg:mx-12 mx-4 mt-10 ">
...
//               Us Our Mission | Our Journey | What We Do | Store Locations
//             </p>
//           </div>

//           <hr className="border border-white lg:mx-12 mx-4 lg:mt-10 mt-5" />

//           <div className="lg:mx-12 mx-4 mt-5 mb-20  ">
            ...
            <div className="grid lg:grid-cols-5 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-6">
              ...
              <div className="ml-0 lg:ml-10">
                ...
                <ul>
                  ...
                  <NavLink
                to="/faq" className="hover:underline">
                      FAQ
                    </NavLink>
                  </li>
                </ul>
              ...
              <div className="ml-0 lg:ml-10">
                ...
                to="/about-us" className="hover:underline">
                  ...
                  <li>
                  <NavLink
                to="/service" className="hover:underline">
                      Services
                    </NavLink>
                  </li>
                  <li>
                  <NavLink
                to="/contact-us"className="hover:underline">
                      Contact Us
                    </NavLink>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul>
                  <li>
                    <a href="mailto:service.sharetax@gmail.com" className="hover:underline">
                      Email: service.sharetax@gmail.com
                    </a>
                  </li>
                  <li>
